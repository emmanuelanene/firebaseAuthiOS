...
class LoginController: UIViewController {
    ...
    private let newUserButton = CustomButton(title: "Create Account", fontSize: .small)
    ...
    @objc private func didTapSignIn() {
        ...
        // Call sign in API
        AuthService.shared.signIn(with: loginRequest) { result, error in
            ...
            // Check for SceneDelegate and update authentication state
